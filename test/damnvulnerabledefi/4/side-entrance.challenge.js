...
describe('[Challenge] Side entrance', function () {
    ...
    before(async function () {
        ...
        const SideEntranceLenderAttackingContract = await ethers.getContractFactory('AttackSideEntranceLenderPool',deployer);
        this.pool = await SideEntranceLenderPoolFactory.deploy();
        this.contractAttacker = await SideEntranceLenderAttackingContract.deploy(this.pool.address);
    ...
    it('Exploit', async function () {
        await this.contractAttacker.connect(attacker).attack(1000);
